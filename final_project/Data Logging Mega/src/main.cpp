...
void getSN025Data(void){
  ...
  // Sensor 1
  voltage = analogRead(SEN0257PIN_1) * 5.00 / 1024; //Sensor output voltage
  pressure1 = (voltage - offSet) * 400; //Calculate water pressure

  // Sensor 2
  voltage = analogRead(SEN0257PIN_2) * 5.00 / 1024; //Sensor output voltage
  pressure2 = (voltage - offSet) * 400; //Calculate water pressure
